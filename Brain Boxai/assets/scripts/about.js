...
function changeCards() {
  ...
  document.querySelector(".author-position-one").textContent =
    "Chairman of the Board";

  document.querySelector(".author-name-two").textContent = "Sean Neely";
  document.querySelector(".author-position-two").textContent =
  ...
  document.querySelector(".author-name-seven").textContent =
    "Dr. Thorsten Müller";
  ...
  document.querySelector(".author-position-eight").textContent =
    "Advisory Board";

  document.querySelector(".author-name-nine").textContent =
    "Angelos Vlasopoulos";
  document.querySelector(".author-position-nine").textContent =
    "Advisory Board";
  ...
  document.querySelector(".author-position-eleven").textContent =
    "Advisory Board";
}
